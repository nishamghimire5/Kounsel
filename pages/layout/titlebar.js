  ...
  return (
    <div className="text_spacing">
      <Navbar bg="light" expand="lg">
        <Container fluid>
          <Link href="/">
            <a className="text-decoration-none text-dark fs-3 fw-bold">
              Kounsel
            </a>
          </Link>
          ...
          <Navbar.Collapse id="navbarScroll">
            ...
            >
              <Link href="/">
                <a
                  className="text-decoration-none text-dark mx-4 fs-6 hoverLink"
                  href=""
                >
                  Home
                </a>
              ...
              <Link href="/about">
                <a
                  className="text-decoration-none text-dark mr-4 fs-6 hoverLink"
                  href=""
                >
                  About
                </a>
              ...
              {status === "authenticated" && (
                <Link href="">
                  <a
                    className="text-decoration-none text-dark ml-4 mr-4 fs-6 hoverLink"
                    href=""
                    onClick={() => signOut()}
                  >
              ...
              <Link href="/login">
                <a
                  className="text-decoration-none text-dark fs-6 hoverLink"
                  href=""
                >
                  Login
                </a>
