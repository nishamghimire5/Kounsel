                ...
                <Navbar.Collapse id="navbarScroll">
                    ...
                    >
                        {status === "authenticated" &&
                            <Link href="/dashboard">
                                <a className='text-decoration-none text-light mx-4 fs-6' href="" >Dashboard</a>
                            </Link>}
                        {status === "unauthenticated" &&
                            <Link href="/">
                                <a className='text-decoration-none text-light mx-4 fs-6' href="" >Home</a>
                            </Link>}
                        <Link href="/about">
                            <a className='text-decoration-none text-light mr-4 fs-6' href="" >About</a>
                        </Link>
                        <Link href="/articles">
                            <a className='text-decoration-none text-light mx-4 fs-6' href="" >Articles</a>
                        </Link>
                        {status === "authenticated" &&
                            <Link href="/mybookings">
                                <a className='text-decoration-none text-light mr-4 fs-6' href="" >My Bookings </a>
                            </Link>}
                        {status === "authenticated" &&
                            <Link href="/profile">
                                <a className='text-decoration-none text-light mx-4 fs-6' href="" >My Profile </a>
                            </Link>}
                        {status === "authenticated" &&
                            <Link href="">
