    ...
    <div>
      ...
      <div className="cards-container">
        ...
        <div class="card" style={{width: 18 +'rem'}}>
            <Image src={session} class="card-img-top" alt="" width={2000} height={2000} />
            <div class="card-body">
        ...
        <div class="col-sm-2">
        <div class="card" style={{width: 18 +'rem'}}>
            <Image src="https://img.freepik.com/premium-vector/people-with-masks-using-smartphones_213110-1146.jpg" class="card-img-top" alt="..." width={2000} height={2000}/>
            <div class="card-body">
        ...
        <div class="col-sm-2">
        <div class="card" style={{width: 18 +'rem'}}>
            <Image src="https://img.freepik.com/free-vector/appointment-booking-with-smartphone_52683-39832.jpg?w=1380&t=st=1662908942~exp=1662909542~hmac=2b868b23f004d5bd519f57dc9323a43564fea85b57cccc3204ef47eaef061e16" class="card-img-top" alt="..." width={2000} height={2000}/>
            <div class="card-body">
        ...
        <div class="col-sm-2">
        <div class="card" style={{width: 18 +'rem'}}>
            <Image src={webinar} class="card-img-top" alt="" width={2000} height={2000}/>
            <div class="card-body">
        ...
        <div class="col-sm-2">
        <div class="card" style={{width: 18 +'rem'}}>
            <Image src="https://img.freepik.com/free-vector/group-therapy-illustrated_23-2148654878.jpg?w=826&t=st=1662909766~exp=1662910366~hmac=aa4e26cd9554572b1f16e19867a189c257f51b70b093c33b9fef72f714870a3c" class="card-img-top" alt="..." width={2000} height={2000}/>
            <div class="card-body">
        ...
        <div class="col-sm-2">
        <div class="card" style={{width: 18 +'rem'}}>
            <Image src="https://cdn.dribbble.com/users/5286978/screenshots/11351248/adspur-_mental_health-01-02.png" class="card-img-top" alt="..." width={2000} height={2000}/>
            <div class="card-body">
